...
download_jhbuild_sources() {
    ...
    # Pin JHBuild independently of gtk-osx's mutable branch name.
    shallow_clone_into_commit "https://gitlab.gnome.org/GNOME/jhbuild.git" "jhbuild" "$HOME/Source/jhbuild"
